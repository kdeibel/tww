...
bool TSequenceProcessor::process_branch_limited_(TSequenceProcessor* proc, u32 choice) {
    ...
    return process_setMessage_index_(proc->mControl, JGadget::binary::TParseValue<JGadget::binary::TParseValue_endian_big_<u16> >::parse((const u16*)work->mTable + choice));
}
